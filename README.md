...
2) Run 2_webscraping_artist_top_song.py. This file adds the top song from each of the top artists to the dataframe.
3) Next run mannually_adding_info.py to add the genders of artists to the dataset
4) Run webscraping_lyrics.py
