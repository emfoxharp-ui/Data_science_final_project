...
1) Run 1_web_scraping_artists.py to produce a csv file with the top 20 english speaking artists (this csv is also already within the folder)
2) Run 2_webscraping_artist_info.py. This file adds the top song from each of the top artists to the dataframe.
