...
2) Run 2_making_databases.py to create the tables in the SQL database and add the artists infos
3) Run 2_webscraping_lyrics.py. This file scrapes for the lyrics of the top songs and word count to the dataframe, and saves it all to a new csv file
