...
import pandas as pd
import numpy as np
search_trends = pd.read_csv('./Data_science_final_project/Datasets/Original_datasets/search_trends.csv')
...
search_trends.to_csv('./Data_science_final_project/Datasets/Cleaned_datasets/cleaned_search_trends.csv', index=False)