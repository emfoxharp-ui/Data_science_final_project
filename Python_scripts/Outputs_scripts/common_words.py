...
with sqlite3.connect('song_lyrics.db') as connection:
    ...
    eliminate = ['oh','ill','ooh','eh','yeah','the','but','can','this','if','youre','and','a','to','of','in','is','you','that','it','for','an', 'was', 'on', 'i', 'me', 'its','with','just','my','im','your','we','be','your','get','got','so']
